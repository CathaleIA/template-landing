...
interface WhatsAppFloatProps {
  phoneNumber: string; // Número de teléfono con código de país (ej: "573001234567")
...
const WhatsAppFloat: React.FC<WhatsAppFloatProps> = ({ 
  ...
  return (
    ...
    >
      {/* Tooltip */}
      <div 
        className={`absolute right-16 top-1/2 transform -translate-y-1/2 bg-gray-800 text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap transition-all duration-300 ${
      ...
      <div className="relative">
        ...
        <div 
          className="relative bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-2xl transition-colors duration-300 flex items-center justify-center"
        >
