...
export default function DashboardSection() {
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-6 mt-8 md:mt-12">
          {t.dashboard.features.map((feature, index) => (
            ...
            >
              {/* Glow effect border */}
              <div
                className={`absolute inset-0 bg-gradient-to-r from-primary/20 via-primary/10 to-primary/20 rounded-xl opacity-0 transition-opacity duration-500 ${
              ...
              <div className="relative h-64 md:min-h-96 overflow-hidden">
                ...
                <div
                  className={`absolute bottom-0 left-0 right-0 p-6 text-white transition-all duration-500 transform ${
                    hoveredCard === feature.value
                ...
                >
                  <div className="flex items-center mb-2">
                    <div
                      className={`w-8 h-8 bg-primary rounded-full flex items-center justify-center mr-3 transition-all duration-300 ${
                        hoveredCard === feature.value
                          ? "scale-110 rotate-12"
                          : "scale-100 rotate-0"
                      }`}
  ...
  from-gray-950/95 via-gray-900/90 to-gray-950/95 backdrop-blur-sm 
    ...
    hoveredCard === feature.value
      ...
      : "opacity-0 invisible scale-105"
                ...
                >
                  <div
                    className={`
    text-center text-white transition-all duration-700 transform w-full
    ${
      hoveredCard === feature.value
        ? "translate-y-0 opacity-100"
        : "translate-y-4 opacity-0"
                  ...
                  >
                    {/* Título: Con más margen inferior y sin 'pulse' */}
        ...
        <div
          className={`text-center mt-8 md:mt-12 transition-all duration-1000 ease-out transform ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"
          }`}
