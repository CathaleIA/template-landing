        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="space-y-1">
              ...
              <Link
                ...
                className="group flex items-center text-gray-600 text-sm hover:text-primary transition-all duration-300 py-2 px-3 rounded-lg hover:bg-primary/5 hover:translate-x-1"
              >
                <div className="w-0 h-0.5 bg-primary transition-all duration-300 group-hover:w-4 mr-0 group-hover:mr-2 rounded-full">
                  {" "}
                </div>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-primary mb-4">
              <Link
                href="/servicesShowcase/"
                className="group relative inline-block align-bottom leading-none"
